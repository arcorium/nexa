...
func NewProfile(profile service.IProfile) ProfileHandler {
...
type ProfileHandler struct {
  authNv1.UnimplementedProfileServiceServer
...
func (p *ProfileHandler) Register(server *grpc.Server) {
  authNv1.RegisterProfileServiceServer(server, p)
}

//func (p *ProfileHandler) Find(ctx context.Context, request *authNv1.FindProfileRequest) (*authNv1.FindProfileResponse, error) {
...
//  response := &authNv1.FindProfileResponse{
...
func (p *ProfileHandler) Update(ctx context.Context, request *authNv1.UpdateProfileRequest) (*emptypb.Empty, error) {
...
func (p *ProfileHandler) UpdateAvatar(server authNv1.ProfileService_UpdateAvatarServer) error {
  // WARN: Bad implementation
