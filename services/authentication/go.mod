module nexa/services/authentication

go 1.22.4

require (
	github.com/arcorium/nexa/proto/gen/go v1.0.5-0.20240726144326-c9a33f107057
	github.com/arcorium/nexa/shared v0.1.7-0.20240725172805-986135e00413
