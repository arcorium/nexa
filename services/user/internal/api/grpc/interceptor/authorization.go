...
func PermissionCheck(claims *sharedJwt.UserClaims, meta interceptors.CallMeta) bool {
  /*  switch meta.FullMethod() {
      ...
      case userv1.UserService_UpdatePassword_FullMethodName:
        return authUtil.ContainsPermission(claims.Roles, constant.USER_UPDATE)
      ...
      case userv1.UserService_FindByIds_FullMethodName:
        return authUtil.ContainsPermission(claims.Roles, constant.USER_GET)
      case userv1.UserService_Banned_FullMethodName:
        return authUtil.ContainsPermission(claims.Roles, constant.USER_BANNED)
      case userv1.UserService_Delete_FullMethodName:
        return authUtil.ContainsPermission(claims.Roles, constant.USER_DELETE, constant.USER_DELETE_ARB)
      case userv1.ProfileService_Find_FullMethodName:
        return authUtil.ContainsPermission(claims.Roles, constant.USER_GET_PROFILE, constant.USER_GET_PROFILE_ARB)
      default:
