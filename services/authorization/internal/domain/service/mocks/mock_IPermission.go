...
// Seed provides a mock function with given fields: ctx, seedDTO
func (_m *PermissionMock) Seed(ctx context.Context, seedDTO []dto.PermissionCreateDTO) ([]types.Id, status.Object) {
	ret := _m.Called(ctx, seedDTO)
...
// PermissionMock_Seed_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Seed'
type PermissionMock_Seed_Call struct {
	*mock.Call
}

// Seed is a helper method to define mock.On call
//   - ctx context.Context
//   - seedDTO []dto.PermissionCreateDTO
func (_e *PermissionMock_Expecter) Seed(ctx interface{}, seedDTO interface{}) *PermissionMock_Seed_Call {
	return &PermissionMock_Seed_Call{Call: _e.mock.On("Seed", ctx, seedDTO)}
}

func (_c *PermissionMock_Seed_Call) Run(run func(ctx context.Context, seedDTO []dto.PermissionCreateDTO)) *PermissionMock_Seed_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]dto.PermissionCreateDTO))
	})
	return _c
...
func (_c *PermissionMock_Seed_Call) Return(_a0 []types.Id, _a1 status.Object) *PermissionMock_Seed_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PermissionMock_Seed_Call) RunAndReturn(run func(context.Context, []dto.PermissionCreateDTO) ([]types.Id, status.Object)) *PermissionMock_Seed_Call {
	_c.Call.Return(run)
	return _c
}
