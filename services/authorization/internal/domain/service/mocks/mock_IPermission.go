...
// FindAll provides a mock function with given fields: ctx, input
...
// PermissionMock_FindAll_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAll'
type PermissionMock_FindAll_Call struct {
	*mock.Call
}
...
func (_e *PermissionMock_Expecter) FindAll(ctx interface{}, input interface{}) *PermissionMock_FindAll_Call {
	return &PermissionMock_FindAll_Call{Call: _e.mock.On("GetAll", ctx, input)}
}

func (_c *PermissionMock_FindAll_Call) Run(run func(ctx context.Context, input *shareddto.PagedElementDTO)) *PermissionMock_FindAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PermissionMock_FindAll_Call) Return(_a0 shareddto.PagedElementResult[dto.PermissionResponseDTO], _a1 status.Object) *PermissionMock_FindAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PermissionMock_FindAll_Call) RunAndReturn(run func(context.Context, *shareddto.PagedElementDTO) (shareddto.PagedElementResult[dto.PermissionResponseDTO], status.Object)) *PermissionMock_FindAll_Call {
	_c.Call.Return(run)
	return _c
}
