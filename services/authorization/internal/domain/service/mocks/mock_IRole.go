...
// RoleMock_FindAll_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetAll'
type RoleMock_FindAll_Call struct {
	*mock.Call
}
...
func (_e *RoleMock_Expecter) FindAll(ctx interface{}, input interface{}) *RoleMock_FindAll_Call {
	return &RoleMock_FindAll_Call{Call: _e.mock.On("GetAll", ctx, input)}
}

func (_c *RoleMock_FindAll_Call) Run(run func(ctx context.Context, input *shareddto.PagedElementDTO)) *RoleMock_FindAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RoleMock_FindAll_Call) Return(_a0 shareddto.PagedElementResult[dto.RoleResponseDTO], _a1 status.Object) *RoleMock_FindAll_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RoleMock_FindAll_Call) RunAndReturn(run func(context.Context, *shareddto.PagedElementDTO) (shareddto.PagedElementResult[dto.RoleResponseDTO], status.Object)) *RoleMock_FindAll_Call {
	_c.Call.Return(run)
	return _c
}
