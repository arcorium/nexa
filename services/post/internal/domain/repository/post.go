...
type IPost interface {
  Get(ctx context.Context, child bool, expectedVisibility entity.Visibility, parameter repo.QueryParameter) (repo.PaginatedResult[entity.Post], error)
  GetBookmarked(ctx context.Context, userId types.Id, parameter repo.QueryParameter) (repo.PaginatedResult[entity.Post], error)
  FindById(ctx context.Context, child bool, ids ...types.Id) ([]entity.Post, error)
  FindByUserId(ctx context.Context, child bool, userId types.Id, expectedVisibility entity.Visibility, parameter repo.QueryParameter) (repo.PaginatedResult[entity.Post], error)
  ...
  UpdateVisibility(ctx context.Context, postId types.Id, visibility entity.Visibility) error
  Edit(ctx context.Context, post *entity.Post) error
