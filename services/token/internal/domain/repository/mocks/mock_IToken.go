...
import (
	context "context"
	entity "nexa/services/token/internal/domain/entity"
...
func (_m *TokenMock) Upsert(ctx context.Context, token *entity.Token) error {
	ret := _m.Called(ctx, token)
...
// TokenMock_Upsert_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Upsert'
type TokenMock_Upsert_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - token *entity.Token
func (_e *TokenMock_Expecter) Upsert(ctx interface{}, token interface{}) *TokenMock_Upsert_Call {
	return &TokenMock_Upsert_Call{Call: _e.mock.On("Upsert", ctx, token)}
}

func (_c *TokenMock_Upsert_Call) Run(run func(ctx context.Context, token *entity.Token)) *TokenMock_Upsert_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*entity.Token))
	})
	return _c
...
func (_c *TokenMock_Upsert_Call) Return(_a0 error) *TokenMock_Upsert_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *TokenMock_Upsert_Call) RunAndReturn(run func(context.Context, *entity.Token) error) *TokenMock_Upsert_Call {
	_c.Call.Return(run)
	return _c
}
