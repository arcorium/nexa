...
import (
	context "context"
	dto "nexa/services/token/internal/domain/dto"
...
// AuthVerify provides a mock function with given fields: ctx, _a1
func (_m *TokenMock) AuthVerify(ctx context.Context, _a1 *dto.TokenAuthVerifyDTO) status.Object {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *dto.TokenAuthVerifyDTO) status.Object); ok {
		r0 = rf(ctx, _a1)
	} else {
...
// TokenMock_AuthVerify_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AuthVerify'
type TokenMock_AuthVerify_Call struct {
	*mock.Call
}

// AuthVerify is a helper method to define mock.On call
//   - ctx context.Context
//   - _a1 *dto.TokenAuthVerifyDTO
func (_e *TokenMock_Expecter) AuthVerify(ctx interface{}, _a1 interface{}) *TokenMock_AuthVerify_Call {
	return &TokenMock_AuthVerify_Call{Call: _e.mock.On("AuthVerify", ctx, _a1)}
}

func (_c *TokenMock_AuthVerify_Call) Run(run func(ctx context.Context, _a1 *dto.TokenAuthVerifyDTO)) *TokenMock_AuthVerify_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*dto.TokenAuthVerifyDTO))
	})
	return _c
}

func (_c *TokenMock_AuthVerify_Call) Return(_a0 status.Object) *TokenMock_AuthVerify_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *TokenMock_AuthVerify_Call) RunAndReturn(run func(context.Context, *dto.TokenAuthVerifyDTO) status.Object) *TokenMock_AuthVerify_Call {
	_c.Call.Return(run)
	return _c
}
